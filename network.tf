...
resource "oci_core_virtual_network" "drupal_mds_vcn" {
...
resource "oci_core_subnet" "drupal_subnet" {
  cidr_block                 = cidrsubnet(var.vcn_cidr, 8, 2)
  display_name               = "drupal_subnet"
  compartment_id             = var.compartment_ocid
  vcn_id                     = oci_core_virtual_network.drupal_mds_vcn.id
  ...
  dhcp_options_id            = oci_core_virtual_network.drupal_mds_vcn.default_dhcp_options_id
